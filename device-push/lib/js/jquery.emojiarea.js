...
(function($, window, document) {
  ...
  */
  ...
  EmojiArea_WYSIWYG.prototype.onChange = function(e) {
    ...
    //Device Push Include to print change into preview
    changeTextarea();
  };
  ...
  EmojiMenu.prototype.hide = function(callback) {
    this.visible = false;
    this.$menu.hide("fast");
    console.log('close -> ' + openEmoji);
    if(openEmoji == true){
       	buttonEmoji.classList.add('ion-android-happy');
    	buttonEmoji.classList.remove('ion-android-cancel');
    	openEmoji = false;
    }
  };
  ...
  EmojiMenu.prototype.show = function(emojiarea) {
    ...
    this.visible = true;
    if(openEmoji == false){
    	buttonEmoji.classList.add('ion-android-cancel');	
    	buttonEmoji.classList.remove('ion-android-happy');
    	openEmoji = true;
    }
  };
